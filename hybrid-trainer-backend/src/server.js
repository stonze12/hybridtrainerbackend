console.log('>>> NESTED_MARKER_98765 — this exact file is running <<<');
...
app.get('/health', (req, res) => res.json({ status: 'ok', timestamp: new Date().toISOString(), marker: 'NESTED_MARKER_98765' }));
